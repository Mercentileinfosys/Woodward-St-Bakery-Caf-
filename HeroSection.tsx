        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-serif text-light leading-tight"
              style={{ perspective: '1000px' }}
            >
              Welcome to
              <br />
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-light">1472014614 0931</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            <div className="relative">
              ...
              >
                ...
                <img
                  ...
                  alt="Artisan Bread"
                  className="relative z-10 rounded-2xl shadow-2xl w-full h-[600px] object-cover hover:brightness-110 transition-all duration-500"
                  style={{ 
              ...
              <motion.div
                ...
                className="absolute top-10 -left-10 glass-effect p-4 rounded-lg"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-10 -right-10 glass-effect p-4 rounded-lg"
              >
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center">
                    <span className="text-primary font-bold text-xl">★</span>
